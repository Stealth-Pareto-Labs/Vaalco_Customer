...
const en: Messages = {
  ...
  "settings.description": "Manage who receives alerts and when.",
  "settings.emailLabel": "Alert recipient email",
  "settings.placeholder": "name@company.com",
  "settings.recipients": "Recipients",
  "settings.addEmail": "Add",
  "settings.noRecipients": "No recipients yet — alerts won't be emailed.",
  "settings.emailExists": "That email is already added.",
  "settings.delivery": "Automatic delivery",
  "settings.criticalImmediate": "Email red (critical) alerts immediately",
  "settings.criticalHint": "High-priority signals are sent the moment they're detected.",
  "settings.digestEnabled": "Send a daily report digest",
  "settings.digestHint": "Non-critical alerts and the routine report are sent once a day at this time.",
  "settings.digestTime": "Time",
  "settings.timezone": "Time zone",
  "settings.sendNow": "Send report now",
  "settings.sending": "Sending…",
  "settings.sentOk": "Report sent to your recipients.",
  "settings.sendError": "Couldn't send the report. Please try again.",
  "settings.save": "Save",
  ...
  "signals.low": "Low",
  "signals.cat.fuel": "Fuel",
  "signals.cat.dp": "DP",
  "signals.cat.maintenance": "Maintenance",
  "signals.cat.engine": "Engine",
  "signals.cat.fluid": "Fluids",
  "signals.cat.hse": "HSE",
...
const fr: Messages = {
  ...
  "settings.description": "Gérez qui reçoit les alertes et à quel moment.",
  ...
  "settings.addEmail": "Ajouter",
  "settings.noRecipients": "Aucun destinataire — les alertes ne seront pas envoyées.",
  "settings.emailExists": "Cet e-mail est déjà ajouté.",
  "settings.delivery": "Envoi automatique",
  "settings.criticalImmediate": "Envoyer immédiatement les alertes rouges (critiques)",
  "settings.criticalHint": "Les signaux prioritaires sont envoyés dès leur détection.",
  "settings.digestEnabled": "Envoyer un résumé quotidien",
  "settings.digestHint": "Les alertes non critiques et le rapport de routine sont envoyés une fois par jour à cette heure.",
  "settings.digestTime": "Heure",
  "settings.timezone": "Fuseau horaire",
  "settings.sendNow": "Envoyer le rapport",
  "settings.sending": "Envoi…",
  "settings.sentOk": "Rapport envoyé à vos destinataires.",
  "settings.sendError": "Échec de l'envoi du rapport. Veuillez réessayer.",
  ...
  "signals.low": "Basse",
  "signals.cat.fuel": "Carburant",
  "signals.cat.dp": "DP",
  "signals.cat.maintenance": "Maintenance",
  "signals.cat.engine": "Moteur",
  "signals.cat.fluid": "Fluides",
  "signals.cat.hse": "HSE",
